...
namespace Titanic.Helpers.Patching
{
    ...
    public class BSPatcher
    {
        ...
        public void Patch(string oldfile, string newfile, string patchfile)
        {
            ...
            */
            ...
            GZipStream controlStream = new(new MemoryStream(cfs), CompressionMode.Decompress);
            GZipStream diffStream = new(new MemoryStream(dfs), CompressionMode.Decompress);
            GZipStream extraStream = new(new MemoryStream(efs), CompressionMode.Decompress);
